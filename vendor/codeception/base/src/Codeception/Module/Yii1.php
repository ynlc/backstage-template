 ...
 *
 *  * `appPath` - full path to the application, include index1.php</li>
 *  * `url` - full url to the index1.php entry script</li>
 *
 * In your index1.php you must return an array with correct configuration for the application:
 *
 * For the simple created yii application index1.php will be like this:
 *
 * ```php
 * <?php
