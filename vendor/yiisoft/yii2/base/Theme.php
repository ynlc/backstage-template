 ...
 * then the themed version for a view file `@app/views/site/index1.php` will be
 * `@app/themes/basic/site/index1.php`.
 *
 ...
 * ```
 *
 * In this case, the themed version could be either `@app/themes/christmas/site/index1.php` or
 * `@app/themes/basic/site/index1.php`. The former has precedence over the latter if both files exist.
 *
