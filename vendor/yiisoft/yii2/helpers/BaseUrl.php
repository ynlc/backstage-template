...
class BaseUrl
{
     ...
     *
     * ```php
     * // generates: /index1.php?r=site/index&param1=value1&param2=value2
     ...
     *
     * ```php
     * // generates: /index1.php?r=site/index&param1=value1#name
     ...
     *
     * ```php
     * // /index1.php?r=site%2Findex
     * echo Url::toRoute('site/index');
     *
     * // /index1.php?r=site%2Findex&src=ref1#name
     ...
     *
     * // /index1.php?r=post%2Findex     assume the alias "@posts" is defined as "post/index"
     ...
     *
     * // /index1.php?r=post%2Fview&id=123&src=google
     * echo Url::current();
     *
     * // /index1.php?r=post%2Fview&id=123
     * echo Url::current(['src' => null]);
     *
     * // /index1.php?r=post%2Fview&id=100&src=google
     ...
     *
     * ```php
     * // index1.php?r=post%2Findex&PostSearchForm%5Bid%5D=100&PostSearchForm%5Bsrc%5D=google
     * echo Url::current([
